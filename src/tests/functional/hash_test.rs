    ...
    A::DigestOutput: Default + AsRef<[u8]> + AsMut<[u8]>,
{
    ...
    print_hex_array(uart, output.as_ref(), 16);
        ...
        Some(&[
            ...
            0x35, 0x07, 0x2c, 0x1a, 0xe5, 0x46, 0x35, 0x0e,
            0x0b, 0xfa, 0x7a, 0xb1, 0x1d, 0x49, 0xdc, 0x6f,
            0x12, 0x9e, 0x72, 0xcc, 0xd5, 0x7e, 0xc7, 0xeb,
            0x67, 0x12, 0x25, 0xbb, 0xd1, 0x97, 0xc8, 0xf1,
        ][..])
    } else if TypeId::of::<A>() == TypeId::of::<Sha384>() {
        Some(&[
            0x7f, 0x25, 0x1a, 0x65, 0xac, 0xbe, 0x92, 0xaf,
            0x4c, 0x6a, 0x6d, 0x62, 0x4c, 0x08, 0x60, 0xd9,
            0xbe, 0x77, 0x32, 0x9e, 0x10, 0xe5, 0xbe, 0xb3,
            0xb9, 0x59, 0x4f, 0x79, 0x16, 0x12, 0x8c, 0xd9,
            0x56, 0x10, 0xa4, 0xd8, 0x4e, 0x3a, 0x83, 0xa2,
            0x4a, 0x72, 0x36, 0x2f, 0x6c, 0x8f, 0x9c, 0x46,
        ][..])
    } else if TypeId::of::<A>() == TypeId::of::<Sha512>() {
        Some(&[
            0x94, 0xf4, 0x27, 0xef, 0xef, 0xa7, 0x4c, 0x12,
            0x30, 0xc3, 0xe9, 0x3c, 0x35, 0x10, 0x4d, 0xcb,
            0xaa, 0x8f, 0xf7, 0x1b, 0xa4, 0x53, 0x75, 0x83,
            0xed, 0x83, 0xc0, 0x44, 0x9d, 0x60, 0x7c, 0x4e,
            0x61, 0xb3, 0x9c, 0x4c, 0x5e, 0xea, 0x55, 0x43,
            0xe0, 0x1d, 0x76, 0xa6, 0x8e, 0x22, 0x3d, 0xa0,
            0x2b, 0x50, 0x05, 0x30, 0xa8, 0x21, 0x56, 0x62,
