    ...
    A::Key: AsRef<[u8]>,
{
    ...
    let expected = if TypeId::of::<A>() == TypeId::of::<Sha256>() {
        Some(&[
            0xde, 0x60, 0xb1, 0xd4, 0x83, 0xd2, 0x00, 0x11,
            0xf1, 0xb4, 0x2f, 0x33, 0x70, 0x0c, 0xb4, 0x4f,
            0xa3, 0x16, 0xc4, 0x43, 0xce, 0x43, 0x03, 0x78,
            0xcb, 0x5d, 0x65, 0x42, 0x7f, 0x64, 0x34, 0x8d,
        ][..])
    } else if TypeId::of::<A>() == TypeId::of::<Sha384>() {
        Some(&[
            0xCC, 0xD7, 0xCA, 0xE4, 0x59, 0xE4, 0x23, 0xB9,
            0x94, 0x06, 0x9A, 0xC1, 0xD3, 0xF8, 0x26, 0x41,
            0x60, 0x88, 0x85, 0xAF, 0x04, 0x3A, 0x33, 0xAD,
            0x51, 0x3E, 0x8E, 0x87, 0x47, 0x19, 0x66, 0x6C,
            0x24, 0xD1, 0xC0, 0xDC, 0x54, 0xAE, 0xBB, 0xB9,
            0x3B, 0x84, 0x34, 0xA1, 0xA9, 0x70, 0x83, 0x6D,
        ][..])
    } else if TypeId::of::<A>() == TypeId::of::<Sha512>() {
        Some(&[
            0xf1, 0x10, 0x1d, 0xe2, 0xb4, 0xfa, 0x09, 0xe6,
            0xfb, 0x04, 0x9d, 0x2e, 0x12, 0x68, 0xdb, 0xe7,
            0x65, 0x09, 0x22, 0x01, 0x75, 0x1a, 0x42, 0x1c,
            0xbc, 0x80, 0x61, 0x09, 0x36, 0x14, 0x35, 0x81,
            0x22, 0x0f, 0x3a, 0x77, 0x1f, 0xff, 0x10, 0xd8,
            0xd8, 0x16, 0x63, 0x19, 0xb6, 0x0d, 0xf0, 0x98,
            0xb3, 0x70, 0xdc, 0x5d, 0x1b, 0x01, 0x71, 0x4d,
    ...
    if let Some(expected) = expected {
        ...
        writeln!(uart, "\r\n{}: No expected value defined.", core::any::type_name::<A>()).unwrap();
    }
}
